...
class FetchLocalWeatherUseCase @Inject constructor(
    ...
    suspend fun invoke(lat: Double, lon: Double): Result<WeatherResponse> {
        return try {
            val response = service.fetchLocalWeather(lat, lon, "094f8efd809ddffb67ce9f8309c7ec0d", "ru", "metric")
